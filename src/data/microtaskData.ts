...
export const TASK_TYPE_META = {
    social_media_posting: { label: "Social Posting", icon: "📢", color: "badge-type", cardClass: "social" },
    email_sending: { label: "Email Sending", icon: "✉️", color: "badge-sky", cardClass: "email" },
    social_media_liking: { label: "Social Liking", icon: "❤️", color: "badge-pending", cardClass: "like" },
};
